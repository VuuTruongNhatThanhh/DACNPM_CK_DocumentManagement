                                ...
                                <td>
                                    <div class="btn-toolbar" role="toolbar">
                                        ...
                                        <div class="btn-group mr-2" role="group">
                                            ...
                                            <form id="approveForm${document.id}" action="/updateDocumentStatus" method="post" onsubmit="return confirm('Bạn có chắc chắn muốn ẩn tài liệu này?');">
                                        ...
                                        <div class="btn-group mr-2" role="group">
                                            ...
                                            <form id="approveForm${document.id}" action="/updateDocumentStatus" method="post" onsubmit="return confirm('Bạn có chắc chắn muốn phục hồi tài liệu này?');">
                                                <input type="hidden" name="documentId" value="<%= document.getId() %>">
                                                <input type="hidden" name="status" value="3">
                                                <button style="background-color: green; color: white; border-color: green" type="submit" class="btn btn-danger">Phục hồi</button>
                                            </form>
                                            <% } %>
